...
const DISCORD_ICON = (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" fillRule="evenodd" clipRule="evenodd" aria-hidden>
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-card border border-border rounded-xl p-8 animate-fade-in-up">
          ...
          <button
            ...
            className="w-full bg-[#5865F2] text-white py-3 rounded-md font-heading uppercase tracking-wider text-sm hover:bg-[#4752C3] transition-all flex items-center justify-center gap-2 disabled:opacity-70 mb-3"
          >
            {discordLoading ? (
          ...
          <button
            ...
            className="w-full bg-white text-gray-800 py-3 rounded-md font-heading uppercase tracking-wider text-sm hover:bg-gray-100 transition-all flex items-center justify-center gap-2 disabled:opacity-70 border border-gray-300"
          >
            {googleLoading ? (
              <><Loader2 className="animate-spin" size={18} /> Connecting to Google...</>
            ) : (
