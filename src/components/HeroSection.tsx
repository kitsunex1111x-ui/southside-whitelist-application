  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        <h1 className="font-heading text-6xl md:text-8xl lg:text-9xl font-bold uppercase tracking-wider mb-4 opacity-0 animate-fade-in-up">
          <span className="text-primary text-glow-red">Southside</span>
          <br />
          <span className="text-foreground">WH App</span>
        </h1>
        <p className="text-lg md:text-xl text-muted-foreground mb-10 opacity-0 animate-fade-in-up" style={{ animationDelay: "200ms" }}>
